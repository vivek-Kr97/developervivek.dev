...
const Projects = () => {
    ...
    fetch("https://api.github.com/users/vivek-Kr97/repos")
      ...
      .then((data) => {
        ...
        const filteredData = data.filter((project) =>
          allowedRepos.includes(project.name)
        );

        const fetchReadmes = filteredData.map(async (project) => {
  ...
  return (
    <div className="p-6 bg-gray-900 min-h-screen text-white pb-10 pd:mb-16 lg:pb-24" id="Projects">
